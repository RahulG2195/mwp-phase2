    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Project Detail 2</li>
            </ol>
        </nav>
    </div>
</section>
<section class="prj_detail_content mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-2">
            <a href="" class="download_pdf"><img src="<?php echo base_url() . MAIN_IMG ?>download_now.png"
                            class="img-fluid img-responsive read_more" alt=""></a>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_01.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_01.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_06.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_06.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_02.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_02.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_03.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_03.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_04.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_04.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_05.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_05.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_07.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_07.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_08.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_08.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/Before_09.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>SuratCastle/After_09.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>AligarhAMU/Before_10.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>AligarhAMU/After_10.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
