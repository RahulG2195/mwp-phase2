                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_10.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_10.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_01.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_01.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_02.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_02.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_03.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_03.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_04.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_04.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_05.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_05.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_06.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_06.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_07.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_07.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_08.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_08.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="card">
                            <div class="beforeafterdefault">
                                <div data-type="data-type-image">
                                    <div data-type="before"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/Before_09.webp"></div>
                                    <div data-type="after"><img src="<?php echo base_url() . PROJECTS ?>Agiyari/After_09.webp"></div>
                                </div>
                            </div>
                        </div>
                    </div>
