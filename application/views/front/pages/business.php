...
<section class="contact-us">
    <div class="container-fluid mt-3 container-background">
        <div class="contact-box">
            <div class="left"></div>
            <div class="right">
                <form action="<?php echo base_url('Contact_us/Business'); ?>" method="post" enctype="multipart/form-data" autocomplete="on" data-aos="fade-up" data-aos-delay="100">
                    <h2 class="mb-lg-5 mb-1 text-capitalize">No query is random or useless</h2>
                    ...
                    <div class="d-flex justify-content-between">
                        <input type="text" name="mobile_number" class="field fifty_field" placeholder="Mobile Number"
                            required="">
                        <input type="text" name="work_location" class="field fifty_field"
                            placeholder="Location">
                    </div>
                    <!-- <select name="select_option" class="field form-control contact_select" id="contactBusinessDropdown"
                        onchange="contact_business_dropdown('contactBusinessDropdown')">
                        <option class="op_select" value="" disabled selected>What you are looking for?</option>
                        <option class="op_select" value="">option 1</option>
                        <option class="op_select" value="">option 2</option>
                        <option class="op_select" value="">option 3</option>
                        <option class="op_select" value="">option 4</option>
                        <option class="op_select" value="">option 5</option>
                    </select> -->
