    ...
    <div class="row">
		    <div class="col-md-12">
				<div class="vendor-catalogue-heading">
					...
					?>
				    <h2>Top Invitations (<?php echo isset($count) ? $count : 0 ?>):</h2>
			    </div>
			</div>
		</div>
        ...
        <div class="row">
			...
			?>
				<div class="col-md-4 vendor-col">
					...
					<a href="<?php echo base_url() . 'vendor-detail/in/' . $value['vendor_seo_url'] ?>">
						<div class="card">
							...
							<div class="card-body">
								...
								<a href="<?php echo base_url() . 'vendor-detail/in/' . $value['vendor_seo_url'] ?>" class="white-text d-flex justify-content-end view-vendor-detail">
