            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Ruksar Mehendi Artist</a></li>
...
<section class="vendor_details common_section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="heading">
                    <h1>Ruksar Mehendi Artist, Bangalore</h1>
                    ...
                    <div class="tab-content" id="myTabsContent">
                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                            <div class="about_vendor common_vendor_detail">
                                ...
                                <h4>About</h4>
                                <p>Ruksar Mehendi Artist is a mehendi service provider based out of Bangalore. What's best than having a name of your beloved imprinted on your hands while you contemplate the bond of togetherness with ease and allurement? If you are planning a grand wedding function and looking for a creative mehendi artist then Ruksar Mehendi Artist can help you in availing amazing designs and patterns with ease and happiness. They make the designs with amazing patterns which will seize your hearts with joy and cheerfulness.</p>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            <div class="service_vendor common_vendor_detail">
                                ...
                                <p>
                                    Ruksar Mehendi Artist provides a plethora of services and amenities which can be selected as per your needs and choices. Some of the services offered include:
                                </p>
