...
<nav aria-label="breadcrumb" >
  <ol class="breadcrumb" style="background:none;">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color: #4D4D4D;">Bridal Jewellery</li>
  </ol>
</nav>
...
<section class="vendor-catalogue-section">
	<div class="container">
        ...
        <?php
					...
					?>
				    <h2>Top Bridal Jewellery (<?php echo isset($count) ? $count : 0 ?>):</h2>
			    </div>
			</div>
		</div>
    ...
    <div class="row">
			...
			?>
				<div class="col-md-4 vendor-col">
					...
					<a href="<?php echo base_url() . 'vendor-detail/bj/' . $value['vendor_seo_url'] ?>">
						<div class="card">
							...
							<div class="card-body">
								...
								<a href="<?php echo base_url() . 'vendor-detail/bj/' . $value['vendor_seo_url'] ?>" class="white-text d-flex justify-content-end view-vendor-detail">
