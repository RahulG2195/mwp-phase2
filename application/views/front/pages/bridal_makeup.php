...
<section class="vendor-catalogue-section">
    ...
    <div class="row">
        ...
        <?php
					...
					?>
				    <h2>Top Bridal Make up (<?php echo isset($count) ? $count : 0 ?>):</h2>
			    </div>
			</div>
		</div>
    ...
    <div class="row">
			...
			?>
				<div class="col-md-4 vendor-col">
					...
					<a href="<?php echo base_url() . 'vendor-detail/mu/' . $value['vendor_seo_url'] ?>">
						<div class="card">
							...
							<div class="card-body">
								...
								<a href="<?php echo base_url() . 'vendor-detail/mu/' . $value['vendor_seo_url'] ?>" class="white-text d-flex justify-content-end view-vendor-detail">
