...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Mehendi Artist
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="vendor-catalogue-heading">
                    <h2>Top Mehendi Artist
                        (2):</h2>
                </div>
            </div>
            <div class="col-md-12">
                <div class="vendor-catalogue-sub-heading">
                    <h6>To improve these suggestions - Fill Requirements for Mehendi Artist</h6>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="<?php echo  base_url() ?>assets/front/image/vendor/RuksarMehndiArtistBangalore.jpeg" class="img-fluid" />
                            <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title font-weight-bold"><a>Ruksar Mehndi Artist</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>4.9</p>
                            <p class="card-text">
                                <b>5</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i> BTM,  Bangalore </strong></p>
            ...
            <div class="col-md-4 vendor-col">
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="<?php echo  base_url() ?>assets/front/image/vendor/BridalMehandiArtist.jpeg" class="img-fluid" />
                            <a href="#!">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                            </a>
                        </div>
                        <div class="card-body">
                            <h6>Groom Wear</h6>
                            <h5 class="card-title font-weight-bold"><a>Bridal Mehandi Artist Atmiyata Jain</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>5.0</p>
                            <p class="card-text">
                                <b>4</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i>Richmond Town,  Bangalore</strong></p>
