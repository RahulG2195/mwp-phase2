...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Decorators
</li>
    </ol>
</nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="vendor-catalogue-heading">
                    <h2>Top Decorators (2):</h2>
                </div>
            </div>
            <div class="col-md-12">
                <div class="vendor-catalogue-sub-heading">
                    <h6>To improve these suggestions - Fill Requirements for Decorators
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="<?php echo  base_url() ?>assets/front/image/vendor/decoratorsarsiminternational.jpeg" class="img-fluid" />
                            <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title font-weight-bold"><a>Arsim International Decorators & Events
</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>5.0

                            </p>
                            <p class="card-text">
                                <b>53</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i>  Mahanagar
,  Lucknow
            ...
            <div class="col-md-4 vendor-col">
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="<?php echo  base_url() ?>assets/front/image/vendor/red-roses-events.jpeg" class="img-fluid" />
                            <a href="#!">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                            </a>
                        </div>
                        <div class="card-body">
                            ...
                            <h5 class="card-title font-weight-bold"><a>Red Roses Events
</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>4.8

                            </p>
                            <p class="card-text">
                                <b>4</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i>Kondhwa
,   Pune
