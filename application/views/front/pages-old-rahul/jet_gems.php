            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Jet Gems</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <img src="<?php echo base_url() . VENDOR ?>jet-gems-bridal-jewellery.jpeg" class="img-fluid vf_img" alt="">
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <img src="<?php echo base_url() . VENDOR ?>jet-gems-bridal-jewellery.jpeg" class="img-fluid" alt="">
                    </div>
                    <div class="col-md-6">
                        <img src="<?php echo base_url() . VENDOR ?>jet-gems-bridal-jewellery.jpeg" class="img-fluid" alt="">
                    </div>
                    ...
                    <div class="col-md-6">
                        <img src="<?php echo base_url() . VENDOR ?>jet-gems-bridal-jewellery.jpeg" class="img-fluid vl_img" alt="">
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="heading">
                    <h1>Jet Gems</h1>
                    <p>Shop 2, 36 Turner Road, Bandra West 400050 Bandra (Mumbai)</p>
                    <hr>
                </div>
                <div class="vrating">
                    ...
                    <div class="tab-content" id="myTabsContent">
                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                            <div class="about_vendor common_vendor_detail">
                                ...
                                <h4>About</h4>
                                <p>Jet Gems is a jeweller located in the city of Mumbai. Every girl is beautiful in her own way and especially when it's her wedding day, it becomes necessary to look the best. The only thing which can add a sparkle to the bridal outfit is an astounding set of jewellery and Jet Gems helps you get yourself the most beautiful and trendiest jewellery that will make your wedding ceremony a significant one. Get a chance to flaunt your personality while you wear the most appreciative set of gems.</p>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            <div class="service_vendor common_vendor_detail">
                                ...
                                <p>
                                    Jet Gems has been catering tonnes of happy services for a long time and knows the worth of special occasions and leaves no stone unturned in shining your day to the fullest. If you wish to get a piece of customised jewellery and have an idea for it then the team of high-skilled staff will make sure you are equipped with the most glorious and elegant piece of jewel. You just have to enter with an idea and your desired requirements.
                                </p>
                                <p>
                                    Jet Gems deals in real, designer, and classic jewellery and offer a wide range of products that can be opted for according to your convenience and needs. They offer a bunch of customised and personalised designs which are highly accessible and can be availed as per your budget preferences, like:
                                </p>
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="vendor_technique common_vendor_detail">
                                ...
                                <p>Advance is partially refundable</p>
                            </div>
                            <div class="vendor_technique common_vendor_detail">
                                <span class="detail_badge"></span>
                                <h4>Features</h4>
                                <div class="ven_feat_div">
                                    <div class="vendor_feature_list">
                                        <ul>
                                            <li><i class="fa fa-check" aria-hidden="true"></i> 30 years+ of Experience </li>
                                            ...
                                            <li><i class="fa fa-check" aria-hidden="true"></i> Kundan Jewellery</li>
                                    ...
                                    <div class="vendor_feature_list">
                                        <ul>
                                            ...
                                            <li><i class="fa fa-check" aria-hidden="true"></i> Polki and Emerald Jewellery</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i> Pendant Sets	</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i> Solitaires</li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i> MangalSutra</li>
