                        ...
                        <div class="col-md-4">
                            <div class="card card-body category-card-1">
                                <div class="category-img-box img-1">
                                    <!-- <img  src="<?php echo  base_url() ?>assets/front/image/icon/Invitations.png">  -->
                                </div>
                                <div class="category-box-content">
                                    <h2 id="category-box-caption-1">Invitations</h2>
                                    <span>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="vendor-catalogue-sub-heading">
                    <h6>To improve these suggestions - Fill Requirements for Invitations</h6>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="<?php echo  base_url() ?>assets/front/image/vendor/SeedPaper1.jpeg" class="img-fluid" />
                            <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title font-weight-bold"><a>Seed Paper Invites by Plantables</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>5.0  </p>
                            <p class="card-text">
                                <b>16</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i>South Extension 1, Delhi</strong></p>
            ...
            <div class="col-md-4 vendor-col">
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h6>Invitations</h6>
                            <h5 class="card-title font-weight-bold"><a>Osprey Invites</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>4.9</p>
                            <p class="card-text">
                                <b>12</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i> Lower Parel, Mumbai </strong></p>
