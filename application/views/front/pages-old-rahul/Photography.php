        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="vendor-catalogue-sub-heading">
                    <h6>To improve these suggestions - Fill Requirements for Photgraphy</h6>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="<?php echo  base_url() ?>assets/front/image/vendor/covernewps.jpeg" class="img-fluid" />
                            <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title font-weight-bold"><a>Studio Nexus Photography</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>5.0  </p>
                            <p class="card-text">
                                <b>1</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i>Dharampeth,  Nagpur</strong></p>
            ...
            <div class="col-md-4 vendor-col">
                ...
                <a href="<?php echo base_url() ?>vendor/blessings_by_trupti">
                    <div class="card">
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="<?php echo  base_url() ?>assets/front/image/vendor/thakurs-filmcity.jpeg" class="img-fluid" />
                            <a href="#!">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                            </a>
                        </div>
                        <div class="card-body">
                            <h6>Photgraphy</h6>
                            <h5 class="card-title font-weight-bold"><a>Thakur's Filmcity</a></h5>
                            <hr class="my-4" />
                            <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>5.0</p>
                            <p class="card-text">
                                <b>3</b> Reviews
                            </p>
                            <p class="lead"><strong><i class="fas fa-location"></i> Nagpur, Sadar
                                </strong></p>
