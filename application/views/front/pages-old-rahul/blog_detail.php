                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="blog_dcontent">
                            <h1>Blog heading line here only- </h1>
                            <h5>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h5>
                            <p> by author names</p>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <img src="<?php echo base_url() . BLOG ?>1.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="blog_detail_content">
                    <h3>You need to find time in your schedule for reading</h3>
    ...
    <div class="container insta_jumbo">
        <div class="row elevate_row">
            <div class="col-12 text-center text-white">
                ...
                <h6><i class="fa fa-instagram text-white"></i> @myweddingpalette</h6>
            ...
            <div class="col-md-6">
                <div class="car_div">
                    ...
                    <div class="user_cont">
                        ...
                        <a href="#"><button class="btn btn-contact">care@myweddingpalette.com</button></a>
                        <a href="#"><button class="btn btn-contact">+91 0000 2222 33</button></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
