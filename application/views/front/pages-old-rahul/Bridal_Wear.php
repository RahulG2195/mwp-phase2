...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Bridal Wear</li>
  </ol>
</nav>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="vendor-catalogue-heading">
				    <h2>Top Bridal Wear (2):</h2>
			    </div>
			</div>
			<div class="col-md-12">
				<div class="vendor-catalogue-sub-heading">
				    <h6>To improve these suggestions - Fill Requirements for Bridal Wear
</h6>
			    </div>
			</div>
		</div>
			...
			<div class="col-md-4 vendor-col">
				...
				<a href="<?php echo base_url()?>vendor/blessings_by_trupti">
                    <div class="card">
                        ...
                        <img src="<?php echo  base_url() ?>assets/front/image/vendor/ella.jpg" class="img-fluid" />
                            <a href="<?php echo base_url()?>vendor/blessings_by_trupti">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title font-weight-bold"><a>Ella</a></h5>
                            <hr class="my-4"/>
                            ...
                            <p class="lead"><strong><i class="fas fa-location"></i> Juhu
,   Mumbai
</strong></p>
			...
			<div class="col-md-4 vendor-col">
				...
				<div class="card">
				    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
				        <img src="<?php echo  base_url() ?>assets/front/image/vendor/Chamee.jpg" class="img-fluid" />
				        <a href="#!">
				          <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
				        </a>
				    </div>
				    <div class="card-body">
				        ...
				        <h5 class="card-title font-weight-bold"><a>Chamee & Palak
</a></h5>
				        <hr class="my-4"/>
				        <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>5.0
</p>
				        ...
				        <p class="lead"><strong><i class="fas fa-location"></i>Vile Parle
,   Mumbai
</strong></p>
