		...
		<div class="row">
			<div class="col-md-12">
				<div class="vendor-catalogue-heading">
				    <h2>Top Bridal Makeup (3):</h2>
			    </div>
			</div>
			<div class="col-md-12">
				<div class="vendor-catalogue-sub-heading">
				    <h6>To improve these suggestions - Fill Requirements for Bridal Makeup</h6>
			    </div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 vendor-col">
				...
				<div class="card">
				    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
				       <img src="<?php echo  base_url() ?>assets/front/image/vendor/Victoria_Makeovers.jpeg" class="img-fluid" />
				        <a href="<?php echo base_url()?>vendor/blessings_by_trupti">
				    ...
				    <div class="card-body">
				    	<h6>Bridal Makeup</h6>
				        <h5 class="card-title font-weight-bold"><a>Victoria Makeovers</a></h5>
				        <hr class="my-4"/>
				        <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>4.9</p>
				        <p class="card-text">
				           <b>15</b> Reviews
				        </p>
				        <p class="lead"><strong><i class="fas fa-location"></i> Tilak Nagar,  Delhi</strong></p>
			...
			<div class="col-md-4 vendor-col">
				...
				<div class="card">
				    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
				        <img src="<?php echo  base_url() ?>assets/front/image/vendor/PolishedbyNidhi.jpeg" class="img-fluid" />
				        <a href="#!">
				          <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
				        </a>
				    </div>
				    <div class="card-body">
				    	<h6>Bridal Makeup</h6>
				        <h5 class="card-title font-weight-bold"><a>Polished by Nidhi</a></h5>
				        <hr class="my-4"/>
				        <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>4.9</p>
				        <p class="card-text">
				           <b>13</b> Reviews
				        </p>
				        <p class="lead"><strong><i class="fas fa-location"></i>Lajpat Nagar 2,  Delhi</strong></p>
            ...
            <div class="col-md-4 vendor-col">
				...
				<div class="card">
				    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
				        <img src="<?php echo  base_url() ?>assets/front/image/vendor/IshitaaGulatiMUA.jpeg" class="img-fluid" />
				        <a href="#!">
				          <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
				        </a>
				    </div>
				    <div class="card-body">
				    	<h6>Bridal Makeup</h6>
				        <h5 class="card-title font-weight-bold"><a>Ishitaa Gulati MUA</a></h5>
				        <hr class="my-4"/>
				        <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i>4.9</p>
				        <p class="card-text">
				           <b>11</b> Reviews
