...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Gift & Invitations</li>
  </ol>
</nav>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="vendor-catalogue-heading">
				    <h2>Top Gift & Invitations Card Maker (2):</h2>
			    </div>
			</div>
			<div class="col-md-12">
				<div class="vendor-catalogue-sub-heading">
				    <h6>To improve these suggestions - Fill Requirements for Gift & Invitations</h6>
			    </div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 vendor-col">
				...
				<div class="card">
				    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
				       <img src="<?php echo  base_url() ?>assets/front/image/vendor/wedding-gifts.jpeg" class="img-fluid" />
				        <a href="<?php echo base_url()?>vendor/blessings_by_trupti">
				          <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
				        </a>
				    </div>
				    <div class="card-body">
				    	<h6>Gift & Invitations</h6>
				        <h5 class="card-title font-weight-bold"><a>Blessings by Trupti</a></h5>
				        <hr class="my-4"/>
				        <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i> 5.0</p>
				        <p class="card-text">
				           <b>0</b> Reviews
				        </p>
				        <p class="lead"><strong><i class="fas fa-location"></i> New Palasia, Indore</strong></p>
			...
			<div class="col-md-4 vendor-col">
				...
				<div class="card">
				    ...
				    <div class="card-body">
				    	<h6>Gift & Invitations</h6>
				        <h5 class="card-title font-weight-bold"><a>The Crafty Hub</a></h5>
				        <hr class="my-4"/>
				        <p class="mb-2"> <i class="fas fa-star text-warning fa-xs"> </i> 5.0</p>
				        <p class="card-text">
				           <b>10</b> Reviews
				        </p>
				        <p class="lead"><strong><i class="fas fa-location"></i>Mahesh Nagar, Mumbai</strong></p>
