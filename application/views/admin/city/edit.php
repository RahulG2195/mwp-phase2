              ...
              <div class="card card-default">
                  ...
                  <!--<div class="card-body">-->
                      ...
                      <form action="<?php echo $editlink; ?>" method="POST">
                          ...
                          <input type="hidden" class="form-control"  name="editid" placeholder="editid" value="<?php echo $editdata['city_id']; ?>">
                          <div class="card-body">
                              <div class="row">
                                  <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="number" class="form-control" name="count_of_city" id="exampleInputCountOfCity" placeholder="Enter count of city" required="" value="<?php echo $editdata['count_of_city']; ?>">
                                      </div>
                                      </div>
                                      <div class="col-md-6">
                                      <div class="form-group">
                                          <label for="exampleInputRank">Rank</label>
                                          <input type="number" class="form-control" name="rank" id="exampleInputRank" placeholder="Enter rank" required="" value="<?php echo $editdata['rank']; ?>">
                                      </div>
                                      </div>
                                      <div class="col-md-6">
                                      <div class="form-group">
