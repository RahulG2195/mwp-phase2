			...
			<div class="col-md-12 col-sm-12 ">
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form id="demo-form2" action="<?php echo  base_url(); ?>admin/achievementsection/add" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									...
									<input type="file" id="last-name"  required="required" class="form-control" name="achievement-image[]" multiple>
