                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="blog-title" id="exampleInputName" placeholder="Enter name">
                                ...
                                <div class="col-md-6">    
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="blog-seo-url" id="exampleInputCountOfCity" placeholder="Enter category url">
                                ...
                                <div class="col-md-6">    
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="meta-title" id="exampleInputCountOfCity" placeholder="Enter category url">
                                    </div>
                                </div>
                                <div class="col-md-6">    
                                    <div class="form-group">
                                        <label for="exampleInputCountOfCity">Meta description</label>
                                        <textarea  class="form-control" name="meta-description" id="exampleInputCountOfCity"></textarea>                                       
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-12">    
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" name="short-description" id="exampleInputCountOfCity"></textarea>
