  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1>Edit Review Parameter</h1>
                  </div>
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/index">Home</a></li>
                          <li class="breadcrumb-item active">Edit Review Parameter</li>
                      </ol>
                  </div>
              </div>
          </div><!-- /.container-fluid -->
              ...
              <div class="card card-default">
                  ...
                  <!--<div class="card-body">-->
                      ...
                      <form action="<?php echo $editlink; ?>" method="POST">
                          ...
                          <input type="hidden" class="form-control"  name="editid" placeholder="editid" value="<?php echo $editdata['review_parameter_id']; ?>">
                          <div class="card-body">
                              <div class="row">
                                  <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="value_json" id="exampleInputValueJson" placeholder="Enter value json" required="" value='<?php echo $editdata['value_json']; ?>' readonly="">
                                      </div>
                                      </div>
                                      <div class="col-md-6">
                                      <div class="form-group">
