                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    if($row['vendor_status'] == 0){
                      echo '<a href="'. base_url() . 'admin/Admin_Vendor/Status_update?tab=cater&status=1&vid='.$row['dv_id'].'"><button class="btn btn-danger">DeActived</button></a>';
                    }else{
                      echo '<a href="'. base_url() . 'admin/Admin_Vendor/Status_update?tab=cater&status=0&vid='.$row['dv_id'].'"><button class="btn btn-success">Activated</button></a>';
                    }
                    ?> </td>
