			...
			<div class="col-md-12 col-sm-12 ">
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form id="demo-form2" action="<?php echo  base_url(); ?>admin/homeslider/add" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									...
									<input type="text" id="first-name" class="form-control" name="slider-title">
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									...
									<input type="text" id="last-name"  class="form-control" name="slider-link">
