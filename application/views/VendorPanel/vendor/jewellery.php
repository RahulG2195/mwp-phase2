        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">jewellery list</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo '<a href="'.base_url() . 'Single_data/bj/'.$row['dv_id'].'"?><button class="btn btn-primary">View All Data</button></a>' ?> </td>
                    <td><?php
                    if($row['vendor_status'] == 0){
                      echo '<a href="'. base_url() . 'VendorPanel/Admin_Vendor/Status_update?tab=jewel&status=1&vid='.$row['dv_id'].'"><button class="btn btn-danger">DeActived</button></a>';
                    }else{
                      echo '<a href="'. base_url() . 'VendorPanel/Admin_Vendor/Status_update?tab=jewel&status=0&vid='.$row['dv_id'].'"><button class="btn btn-success">Activated</button></a>';
                    }
                    ?> </td>
