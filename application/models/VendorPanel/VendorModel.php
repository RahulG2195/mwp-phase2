...
class VendorModel extends CI_Model
{
  ...
  function Fetch_single_data($tab, $id)
  {
    if ($tab == 'bw') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = bridal_jewellery.vin_id', 'left');
    } elseif ($tab == 'ct') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = catering.vin_id', 'left');
    } elseif ($tab == 'dc') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = gift.vin_id', 'left');
    } elseif ($tab == 'gw') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = groom_wear.vin_id', 'left');
    } elseif ($tab == 'in') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = inivitations.vin_id', 'left');
    } elseif ($tab == 'mu') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = make_up.vin_id', 'left');
    } elseif ($tab == 'me') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = mehendi.vin_id', 'left');
    } elseif ($tab == 'ph') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = photography.vin_id', 'left');
    } elseif ($tab == 've') {
      ...
      $this->db->join('default_vendor_inp', 'default_vendor_inp.vendor_uid = venue.vin_id', 'left');
    }
